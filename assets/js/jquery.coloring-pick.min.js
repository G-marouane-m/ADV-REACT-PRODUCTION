(function(e,l){var f={_template:function(a,c){var b=e.extend({color:"#ffffff",alpha:1,swatches:[],picker:"solid",inline:!1,theme:"light"},c),g="solid"==b.picker?" selected":"",h="gradient"==b.picker?" selected":"";var d='<div class="_coloring_inner" style="width:450px;"><div class="spr_row"><div class="spr_column"><div class="spr_column-inner"><div class="spr_wrapper _col_pick_type_btn_wrapper">'+('<a class="_col_pick_type_btn single_color col_btn'+g+'" data-type="solid">Solid Color</a>')+('<a class="_col_pick_type_btn gradient_color col_btn'+
h+'" data-type="gradient">Gradient Color</a>')+"</div>";d+="</div>";d+="</div>";d+="</div>";d=d+('<div class="_coloring_solid_color_container _col_picker_content spr_row'+g+'">')+'<div class="spr_column spr_col-6">';d+='<div class="spr_column-inner">';d+='<div class="spr_wrapper">';d+='<div class="gradient_creator">';d+=f._colorPicker(a,b);d+="</div>";d+="</div>";d+="</div>";d+="</div>";d+="</div>";d+='<div class="_coloring_gradient_color_container _col_picker_content spr_row'+h+'">';d+='<div class="spr_column spr_col-6">';
d+='<div class="spr_column-inner">';d+='<div class="spr_wrapper">';d+='<div class="gradient_creator">';d+=f._colorPicker(a,b);d+="</div>";d+='<div class="col_slider_container">';d+='<div class="col_gradient_slider"></div>';d+='<div class="add_new_gradient_color"></div>';d+="</div>";d+='<div style="margin:10px 0;">';d+='<div class="col_check_btn remove_gradient_color remove_color col_clear_btn"><div class="colico-Trash"></div></div>';d+="</div>";d+="</div>";d+="</div>";d+="</div>";d+='<div class="spr_column spr_col-6">';
d+='<div class="spr_column-inner">';d+='<div class="spr_wrapper">';d+='<div class="spr_row">';d+='<div class="spr_column spr_col-6">';d+='<div class="spr_column-inner">';d+=f._align_tool_template(a,b);d+="</div>";d+="</div>";d+='<div class="spr_column spr_col-6">';d+='<div class="spr_column-inner">';d+='<div class="col_gradient_preview"></div>';d+="</div>";d+="</div>";d+="</div>";d+='<div class="_gradient_type_selector" style="margin:10px 0; text-align:right;">';d+='<a class="linear_gradient gradient_type_btn col_btn" data-type="linear">Linear</a>';
d+='<a class="radial_gradient gradient_type_btn col_btn" data-type="radial">Radial</a>';d+="</div>";d+="</div>";d+="</div>";d+="</div>";d+="</div>";d+='<div style="margin:10px 0; text-align:right;position: absolute;bottom: 20px;right: 0;">';!0!==b.inline&&(d+='<div class="col_check_btn col_clear_btn _close_colpicker"><div class="colico-Cross"></div></div>');d+='<div class="col_check_btn _close_colpicker"><div class="colico-Check"></div></div>';d+="</div>";return d+="</div>"},_align_tool_template:function(a,
c){return'<div class="_coloring_pick_gradient_rotation"><span>Angle</span><div class="_coloring_aligntool coloring_align_yellow"><div class="coloring_line_hz" style="left: 12px; top: 5px;"></div><div class="coloring_line_hz" style="left: 31px; top: 5px;"></div><div class="coloring_line_hz" style="left: 12px; bottom: 5px;"></div><div class="coloring_line_hz" style="left: 31px; bottom: 5px;"></div><div class="coloring_line_vt" style="left: 5px; top: 12px;"></div><div class="coloring_line_vt" style="left: 5px; top: 31px;"></div><div class="coloring_line_vt" style="right: 5px; top: 12px;"></div><div class="coloring_line_vt" style="right: 5px; top: 31px;"></div><div class="coloring_align_control coloring_align_topLeft" data-deg="135"></div><div class="coloring_align_control coloring_align_centerTop" data-deg="180"></div><div class="coloring_align_control coloring_align_topRight" data-deg="225"></div><div class="coloring_align_control coloring_align_middleLeft" data-deg="90"></div><div class="coloring_align_control coloring_align_center" data-deg=""></div><div class="coloring_align_control coloring_align_middleRight" data-deg="270"></div><div class="coloring_align_control coloring_align_bottomLeft" data-deg="45"></div><div class="coloring_align_control coloring_align_centerBottom" data-deg="0"></div><div class="coloring_align_control coloring_align_bottomRight" data-deg="315"></div></div></div>'},
_activate_align_tool:function(a,c){a.find('.coloring_align_control[data-deg = "'+c.gradient.angle+'"]').addClass("coloring_align_selected");a.find(".gradient_type_btn[data-type = "+c.gradient.type+"]").addClass("selected");"linear"===c.gradient.type&&a.find(".coloring_align_center").hide();a.find(".coloring_align_control").bind("click",function(b){b.preventDefault();e(this).data("deg");a.find(".coloring_align_control").removeClass("coloring_align_selected");e(this).addClass("coloring_align_selected");
f._create_gradient(a,c)});a.find(".gradient_type_btn").bind("click",function(b){b.preventDefault();b=e(this).data("type");a.find(".gradient_type_btn").removeClass("selected");e(this).addClass("selected");"radial"===b?a.find("._coloring_pick_gradient_rotation").find(".coloring_align_center").show():a.find("._coloring_pick_gradient_rotation").find(".coloring_align_center").hide();f._create_gradient(a,c);console.log(b)})},_colorPicker:function(a,c){return"<div>"+('<input type="text" class="miniColorsPicker" value="'+
e.extend({color:"#ffffff",alpha:1,swatches:"",picker:"solid"},c).color+'">')+"</div>"},_col_set_data:function(a){a.itm.attr("data-"+a.data,a.value);a.itm.data(a.data,a.value)},_create_gradient:function(a,c){var b=e.extend({change:null},c),g=[],h="",d="";h=a.find("._coloring_aligntool").find(".coloring_align_selected").data("deg");d=a.find("._gradient_type_selector").find(".selected").data("type");e.each(a.find(".col_gradient_slider").children("a"),function(a,b){var d=e(b).data("color"),c=e(b).data("alpha");
d=f._hexToRgbA(d,c);var h=e(b).data("percent");g[a]={percent:h,color:d,alpha:c}});g.sort(function(a,b){return parseFloat(a.percent)-parseFloat(b.percent)});var k={type:d,angle:h,points:g},m=f._selected_picker_type(a);h=f._col_create_css(k,"full");d=f._col_create_css(k,"single");a.find(".col_gradient_preview").css({background:d});a.find(".col_gradient_slider").css({background:"linear-gradient(90deg, "+f._col_create_css(k,"gradient_string")+" )"});"gradient"==m&&(a.parent().find("._cpt_inner").css({background:d}),
a.parent().find("._col_input_preview").attr("value",d),"input"===b.itm[0].nodeName.toLowerCase()?b.itm.attr("value",d):"textarea"===b.itm[0].nodeName.toLowerCase()&&b.itm.val(d),f._col_set_data({itm:b.itm,data:"color",value:d}));b.change&&b.change.call(a.get(0),h)},_col_create_css:function(a,c){var b="",g="",e="",d="";c="undefined"!==typeof c?c:"full";jQuery.each(a.points,function(d,c){e=d?",":"";split=d?"|":"";b+=e+a.points[d].color+" "+a.points[d].percent+"%"});"linear"===a.type?(d+="background:-ms-linear-gradient("+
a.angle+"deg, "+b+");",d+="background:-webkit-linear-gradient("+a.angle+"deg, "+b+");",d+="background:-moz-linear-gradient("+a.angle+"deg, "+b+");",d+="background:-o-linear-gradient("+a.angle+"deg, "+b+");",d+="background:linear-gradient("+a.angle+"deg, "+b+");",g="linear-gradient("+a.angle+"deg, "+b+")"):(g=f._radial_gradient_positioning(a.angle),d=d+("background:-ms-radial-gradient(ellipse "+g+", "+b+");")+("background:-webkit-radial-gradient(ellipse "+g+", "+b+");")+("background:-moz-radial-gradient(ellipse "+
g+", "+b+");")+("background:-o-radial-gradient(ellipse "+g+", "+b+");")+("background:radial-gradient(ellipse "+g+", "+b+");"),g="radial-gradient(ellipse "+g+", "+b+")");return"gradient_string"==c?b:"single"==c?g:d},_radial_gradient_positioning:function(a){var c="farthest-side at 50% 50%";135===a?c="farthest-side at 0% 0%":180===a?c="farthest-side at 50% 0%":225===a?c="farthest-side at 100% 0%":45===a?c="farthest-side at 0% 100%":90===a?c="farthest-side at 0% 50%":270===a?c="farthest-side at 100% 50%":
315===a?c="farthest-side at 100% 100%":0===a&&(c="farthest-side at 50% 100%");return c},_radial_gradient_positioning_reverse:function(a){return deg="0% 0%"==a?135:"50% 0%"==a?180:"100% 0%"==a?225:"0% 100%"==a?45:"0% 50%"==a?90:"100% 50%"==a?270:"100% 100%"==a?315:"50% 100%"==a?0:""},_update_points_data_array:function(a,c){e.each(a.find(".col_gradient_slider").children("a"),function(a,g){c[a]={color:e(g).data("color"),alpha:e(g).data("alpha"),percent:e(g).data("percent")}})},_selected_picker_type:function(a){return a.find("._col_pick_type_btn.selected").data("type")},
_activateColorPicker:function(a,c){var b=e.extend({format:"hex",color:"#ffffff",alpha:1,swatches:[],gradient_points:[],picker:"solid"},c);"solid"==b.picker&&a.find(".miniColorsPicker").val(b.itm.val());a.find(".miniColorsPicker").minicolors({format:b.format,opacity:b.alpha,inline:!0,swatches:b.swatches,change:function(c,e){if(c){var d=f._hexToRgbA(c,e);"gradient"==f._selected_picker_type(a)?(a.find(".active_point").css({"background-color":d}),f._col_set_data({itm:a.find(".active_point"),data:"color",
value:c.replace(/ /g,"")}),f._col_set_data({itm:a.find(".active_point"),data:"alpha",value:e}),f._update_points_data_array(a,b.gradient.points),f._create_gradient(a,b)):(a.parent().find("._cpt_inner").css({background:d}),a.parent().find("._col_input_preview").attr("value",d),"input"===b.itm[0].nodeName.toLowerCase()?b.itm.attr("value",d):"textarea"===b.itm[0].nodeName.toLowerCase()&&b.itm.val(d),f._col_set_data({itm:b.itm,data:"color",value:d}),b.change&&b.change.call(a.get(0),d))}}})},_hexToRgbA:function(a,
c){if(/^#([A-Fa-f0-9]{3}){1,2}$/.test(a)){var b=a.substring(1).split("");3==b.length&&(b=[b[0],b[0],b[1],b[1],b[2],b[2]]);b="0x"+b.join("");return"rgba("+[b>>16&255,b>>8&255,b&255].join()+","+c+")"}return a;throw Error("Bad Hex");},_create_gradient_slider:function(a,c){var b=e.extend({format:"hex",color:"#ffffff",alpha:1,swatches:"",gradient_points:[]},c),g=b.values,h=b.val;a.find(".col_gradient_slider").slider({min:0,max:100,steps:1,values:g,create:function(d,c){jQuery.each(a.find(".col_gradient_slider").children("a"),
function(a,d){f._col_set_data({itm:e(d),data:"nr",value:a});f._col_set_data({itm:e(d),data:"percent",value:g[a]});"undefined"==typeof b.gradient.points[a]&&(f._col_set_data({itm:e(d),data:"color",value:"#ffffff"}),f._col_set_data({itm:e(d),data:"alpha",value:.5}),b.gradient.points[a]={color:"#ffffff",alpha:.5,percent:h},e(d).css({"background-color":f._hexToRgbA("#ffffff",.5),left:h+"%"}))});a.find(".col_gradient_slider")._colSortElements("a","nr");b.gradient.points.sort(function(a,b){return parseFloat(a.percent)-
parseFloat(b.percent)});jQuery.each(a.find(".col_gradient_slider").children("a"),function(a,d){"undefined"!=typeof b.gradient.points[a]&&(f._col_set_data({itm:e(d),data:"color",value:b.gradient.points[a].color}),f._col_set_data({itm:e(d),data:"alpha",value:b.gradient.points[a].alpha}),e(d).css({"background-color":f._hexToRgbA(b.gradient.points[a].color,b.gradient.points[a].alpha),left:b.gradient.points[a].percent+"%"}))})},change:function(d,c){a.find(".col_gradient_slider").find("a").removeClass("active_point");
e(c.handle).addClass("active_point");f._col_set_data({itm:e(c.handle),data:"percent",value:c.value});a.find(".miniColorsPicker").val(e(c.handle).data("color"));a.find(".miniColorsPicker").minicolors("opacity",e(c.handle).data("alpha"));f._create_gradient(a,b)},slide:function(d,c){a.find(".col_gradient_slider").find("a").removeClass("active_point");e(c.handle).addClass("active_point");f._col_set_data({itm:e(c.handle),data:"percent",value:c.value});f._create_gradient(a,b)}})},_new_gradient_point_btn:function(a,
c){var b=e.extend({format:"hex",color:"#ffffff",alpha:1,swatches:"",gradient:{}},c);a.find(".add_new_gradient_color").bind("click",function(c){c.preventDefault();var g=e(this).offset();c=(c.pageX-g.left)/jQuery(this).width()*100;c=100<c?100:Math.round(c);f._update_points_data_array(a,b.gradient.points);a.find(".col_gradient_slider").slider("destroy");b.values.push(c);b.val=c;b.values.sort(function(a,b){return parseFloat(a)-parseFloat(b)});f._create_gradient_slider(a,b);f._create_gradient(a,b);f._enable_remove_gradient_point_btn(a);
a.find(".col_gradient_slider").find("a").removeClass("active_point");a.find(".col_gradient_slider").find("a[data-percent = "+c+"]").addClass("active_point")})},_remove_gradient_point_btn:function(a,c){var b=e.extend({format:"hex",color:"#ffffff",alpha:1,swatches:"",gradient:{}},c);a.find(".remove_gradient_color").bind("click",function(c){c.preventDefault();c=a.find(".col_gradient_slider").find(".active_point");color=c.data("color");percent=c.data("percent");nr=c.data("nr");b.values.splice(e.inArray(percent,
b.values),1);b.gradient.points.splice(nr,1);c.remove();a.find(".col_gradient_slider").slider("destroy");f._create_gradient_slider(a,b);f._create_gradient(a,b);f._enable_remove_gradient_point_btn(a)})},_enable_remove_gradient_point_btn:function(a){2<a.find(".col_gradient_slider").find("a").length?a.find(".remove_gradient_color").show():a.find(".remove_gradient_color").hide()},_close_coloring_picker:function(a,c){e("._close_colpicker").bind("click",function(b){b.preventDefault();!0!==c.inline&&(e(this).closest("._coloring_inner").remove(),
a.unwrap(),e(this).hasClass("col_clear_btn")&&(c.itm.attr("value",""),a.parent().find("._cpt_inner").css({background:""}),a.parent().find("._col_input_preview").attr("value","")))})},_change_picker_type:function(a,c){e("._col_pick_type_btn").bind("click",function(b){b.preventDefault();b=e(this).data("type");c.picker=b;a.find("._col_pick_type_btn").removeClass("selected");e(this).addClass("selected");a.find("._col_picker_content").removeClass("selected");a.find("._coloring_"+b+"_color_container").addClass("selected")})},
_frontend_picker_template:function(a){var c="";"undefined"!==typeof a&&(c=' style="background:'+a+';"');return a='<span class="_col_pick_tool">'+('<span class="_cpt_inner col-colorbox"'+c+"></span>")+'<span class="col-colorbtn">Color</span></span>'},_create_value_array:function(a,c){if(""!==a){var b=JSON.parse(f._colpick_encoder(JSON.stringify(a),"decode"));c.gradient=b}},_colpick_encoder:function(a,c){var b=a;"encode"==("undefined"!==typeof c?c:"encode")?(b=JSON.stringify(b),b=b.replace(/"/g,"&")):
(b=b.replace(/"/g,""),b=b.replace(/&/g,'"'));return b},_split_string:function(a,c,b){a=a.split(c);return[a.slice(0,b),a.slice(b)].map(function(a){return a.join(c)})},_create_gradient_array_from_value:function(a,c){if(""!==a&&30<a.length){var b=a,g=b.split("-gradient")[0];b=b.substring(b.indexOf("(")+1);var h="",d=[];-1!==b.indexOf("deg")?(h=b.split("deg")[0],b=b.split("deg")[1]):(d=f._split_string(b,"%",2),h=d[0].split("at")[1],h=h.trim(),h=h.split(" "),h=f._radial_gradient_positioning_reverse(h[0]+
" "+h[1]+"%"),b=d[1]);b=b.substring(0,b.length-1);b=b.split("%");var k=[];b=b.filter(String);e.each(b,function(a,b){var c=b.substring(1,b.length);c=c.trim();k[a]={color:c.split(" ")[0],alpha:1,percent:c.split(" ")[1]}});c.gradient={type:g,angle:h,points:k}}}};e.fn.coloringPick=function(a){var c=e.extend({swatches:"",gradient:{type:"linear",angle:90,points:[{color:"#ffffff",alpha:1,percent:0},{color:"#000000",alpha:.5,percent:100}]},change:null,inline:!1,picker:"",show_input:!1,theme:"light"},a);return this.each(function(a,
g){function b(){if(!e(g).parent().hasClass("_coloring_pick_container")){c=e.extend({itm:e(g)},c);c.swatches="undefined"!==typeof e(g).data("swatches")?e(g).data("swatches").split("|"):c.swatches;c.inline="undefined"!==typeof e(g).data("inline")?e(g).data("inline"):c.inline;f._create_gradient_array_from_value(e(g).val(),c);""==c.picker&&(c.picker=30<e(g).val().length?"gradient":"solid");var a='<div class="_coloring_pick_container '+c.theme+(!1!==c.inline?"":" pop")+'" />',b=[];jQuery.each(c.gradient.points,
function(a,c){b[a]=c.percent});c=e.extend({values:b,val:23},c);e(g).wrap(a).after(f._template(h,c));var h=e(g).parent();f._change_picker_type(h,c);f._activateColorPicker(h,c);f._create_gradient_slider(h,c);f._new_gradient_point_btn(h,c);f._remove_gradient_point_btn(h,c);f._enable_remove_gradient_point_btn(h);f._activate_align_tool(h,c);f._create_gradient(h,c);f._close_coloring_picker(e(g),c)}}e(g).wrap('<div class="_colpick_tool_cont" />');!1!==c.inline?b():(e(g).hide(),e(g).after(f._frontend_picker_template(e(g).val())),
e(g).next("._col_pick_tool").bind("click",b),c.show_input&&e(g).next("._col_pick_tool").append('<input type="text" class="_col_input_preview" value="'+e(g).val()+'" />'));window.location.hostname!==atob("dHV0c3ZpbGxlLmNvbQ==")&&alert(atob("Q29sb3JpbmdQaWNrOiBJbGxlZ2FsIGxpY2Vuc2UhIE1ha2Ugc3VyZSB0byBnZXQgYSB2YWxpZCBsaWNlbnNlIHRvIHVzZSB0aGlzIHNvZnR3YXJlLg=="))})}})(jQuery,window);
jQuery.fn._colSortElements=function(e,l){jQuery("> "+e,this[0]).sort(function(e,a){return jQuery(a).data(l)<jQuery(e).data(l)?1:-1}).appendTo(this[0])};
